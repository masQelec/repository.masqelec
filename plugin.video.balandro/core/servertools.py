...
def corregir_other(srv):
    ...
    elif 'filemoon' in srv or 'fmoonembed' in srv or 'embedmoon' in srv or 'moonjscdn' in srv or 'l1afav' in srv or 'byseqekaho' in srv or 'bysedikamoum' in srv or 'bysevepoin' in srv or 'byseraguci' in srv or 'byse' in srv: srv = 'Filemoon'
