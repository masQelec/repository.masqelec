...
def mainlist_pelis(item):
    ...
    itemlist.append(item.clone ( title = 'Catálogo', action = 'list_all', url = host + 'pelicula/' ))

    itemlist.append(item.clone ( title = 'Por género', action = 'generos', search_type = 'movie' ))
    itemlist.append(item.clone ( title = 'Por año', action = 'anios', search_type = 'movie' ))

    itemlist.append(item.clone ( title = 'Por dirección', action = 'directores_actores', tipo = 'directores' ))
    itemlist.append(item.clone ( title = 'Por interprete', action = 'directores_actores', tipo = 'actores' ))
...
def list_all(item): 
    ...
    for article in matches[item.page * perpage:]:
        ...
        if year and year in title: title = title.replace(year, '').strip()
...
def extraer_mycinedesiempre(data):
    ...
    for url, txt in matches:
        ...
        itemlist.append(Item( channel = 'cinemaclasic', action = 'play', server = servidor, title = '', url = url, language = lang ))
...
def extraer_embeds(data):
    ...
    for tipo in ['iframe', 'source']:
        ...
        for url in matches:
            ...
            itemlist.append(Item( channel = 'cinemaclasic', action = 'play', server = servidor, title = '', url = url ))
