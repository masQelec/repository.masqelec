...
def acciones(item):
    ...
    itemlist.append(Item( channel='actions', action='show_old_domains', title='[COLOR coral][B]Historial Dominios[/B][/COLOR]', channel_id = 'estrenosdoramas', thumbnail=config.get_thumb('estrenosdoramas') ))
