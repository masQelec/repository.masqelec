...
def mainlist_series(item):
    ...
    itemlist.append(item.clone( title = 'Catálogo', action = 'list_all', url = host + 'telenovela/' ))

    itemlist.append(item.clone( title = 'Nuevos episodios', action = 'last_episodes', url = host + 'novela/' ))
