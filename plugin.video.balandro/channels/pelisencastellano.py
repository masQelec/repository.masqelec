...
def mainlist_pelis(item):
    ...
    itemlist.append(Item( channel='helper', action='show_help_pelisencastellano', title='[COLOR aquamarine][B]Aviso[/COLOR] [COLOR green]Información[/B][/COLOR] canal', thumbnail=config.get_thumb('help') ))
