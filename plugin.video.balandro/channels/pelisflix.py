...
host = 'https://pelisflix.biz/'


# ~ por si viene de enlaces guardados
ant_hosts = ['https://pelisflix.li/', 'https://pelisflix2.one/', 'https://ww1.pelisflix2.one/',
             'https://ww2.pelisflix2.one/', 'https://ww3.pelisflix.biz/']


domain = config.get_setting('dominio', 'pelisflix', default='')

if domain:
    if domain in str(ant_hosts): config.set_setting('dominio', '', 'pelisflix')
    else: host = domain
...
def mainlist_pelis(item):
    ...
    itemlist.append(item.clone( title = 'Catálogo', action = 'list_all', url = host + 'peliculas-online-hd3/', search_type = 'movie' ))
...
def mainlist_series(item):
    ...
    itemlist.append(item.clone( title = 'Catálogo', action = 'list_all', url = host + 'series-online-hd3/', search_type = 'tvshow' ))
