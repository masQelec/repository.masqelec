...
IDIOMAS = {'es': 'Esp', 'ar': 'Lat', 'pe': 'Lat', 'mx': 'Lat', '?': '?', 'iberian spanish': 'Esp', 'español latino': 'Lat', 'vose': 'Vose'}
...
def extraer_embeds(data):
    ...
    for tipo in ['iframe', 'source']:
        ...
        for url in matches:
            ...
            itemlist.append(Item( channel = 'zoowoman', action = 'play', server = servidor, language = '?', title = '', url = url, other = 'iframe/source' ))
