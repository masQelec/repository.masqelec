...
def mainlist(item):
    ...
    if config.get_setting('mnu_simple', default=False):
        if config.get_setting('sub_mnu_special', default=True):
            itemlist.append(item.clone( action='submnu_special', title='Especiales', extra='all', thumbnail=config.get_thumb('heart') ))
...
def channels(item):
    ...
    if item.extra == 'movies':
        ...
        itemlist.append(Item( channel='search', action='search', search_type='movie', title='Buscar Película ...',
                              extra = 'movies', context=context, thumbnail=config.get_thumb('search'), text_color='yellowgreen' ))
        ...
        itemlist.append(Item( channel='search', action='search', search_type='tvshow', title='Buscar Serie ...',
                              extra = 'tvshows', context=context, thumbnail=config.get_thumb('search'), text_color='yellowgreen' ))
        ...
        itemlist.append(Item( channel='search', action='search', search_type='documentary', title='Buscar Documental ...',
                              extra = 'documentaries', context=context, thumbnail=config.get_thumb('search'), text_color='yellowgreen' ))
        ...
        if config.get_setting('sub_mnu_special', default=True):
            itemlist.append(item.clone( action='submnu_special', title='Especiales', extra='documentaries', thumbnail=config.get_thumb('heart'), text_color='pink' ))
        ...
        itemlist.append(Item( channel='search', action='search', search_type='all', title='Buscar Película y/o Serie ...',
                              extra = 'mixed', context=context, thumbnail=config.get_thumb('search'), text_color='yellowgreen' ))
        ...
        itemlist.append(Item( channel='search', action='search', search_type='all', title='Buscar Torrent película y/o Serie ...',
                              extra = 'only_torrents', context=context, thumbnail=config.get_thumb('search'), text_color='yellowgreen' ))

        if config.get_setting('sub_mnu_special', default=True):
            itemlist.append(item.clone( action='submnu_special', title='Especiales', extra='torrents', thumbnail=config.get_thumb('heart'), text_color='pink' ))
...
def submnu_special(item):
    ...
    if item.extra == 'all' or item.extra == 'mixed' or item.extra == 'tvshows':
        itemlist.append(item.clone( title = 'Series búsquedas a través de listas:', thumbnail=config.get_thumb('tvshow'), action = '', text_color='pink' ))
    ...
    if item.extra == 'all' or item.extra == 'mixed' or item.extra == 'documentaries':
        itemlist.append(item.clone( title = 'Documentales búsquedas a través de listas:', thumbnail=config.get_thumb('documentary'), action = '', text_color='pink' ))
    ...
    itemlist.append(item.clone( title = 'Películas y series búsquedas a través de listas:', thumbnail=config.get_thumb('heart'), action = '', text_color='pink' ))
