...
def get_video_url(page_url, url_referer=''):
    ...
    if not video_urls:
        if xbmc.getCondVisibility('System.HasAddon("script.module.resolveurl")'):
            path = translatePath(os.path.join('special://home/addons/script.module.resolveurl/lib/resolveurl/plugins/', 'streamvid.py'))
            ...
            if config.get_setting('servers_time', default=True):
                platformtools.dialog_notification('Cargando [COLOR cyan][B]Streamvid[/B][/COLOR]', 'Espera requerida de %s segundos' % espera)
