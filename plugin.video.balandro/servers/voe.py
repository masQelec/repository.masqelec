...
def get_video_url(page_url, url_referer=''):
    ...
    if not video_urls:
        if xbmc.getCondVisibility('System.HasAddon("script.module.resolveurl")'):
            path = translatePath(os.path.join('special://home/addons/script.module.resolveurl/lib/resolveurl/plugins/', 'voesx.py'))
            ...
            if config.get_setting('servers_time', default=True):
                platformtools.dialog_notification('Cargando [COLOR cyan][B]Voesx[/B][/COLOR]', 'Espera requerida de %s segundos' % espera)
            ...
            try:
                ...
                page_url = page_url.replace('/yodelswartlike.com/', '/voe.sx/')
