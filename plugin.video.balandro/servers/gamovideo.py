...
def get_headers(url_referer=''):
    h = {}
    # ~ h['Referer'] = url_referer if url_referer else 'http://gamovideo.com/'
    # ~ h['Referer'] = 'http://gamovideo.com/'
    h['Cookie'] = 'sugamun=1; invn=1; pfm=1'

    # ~ ff_versions = [71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84]  # (Windows NT 10.0)
    ff_versions = [78, 79, 80, 81, 82, 84, 85, 86, 87, 88, 89]  # (Windows NT 10.0; Win64; x64; rv:%s.0)
    # ~ ff_versions = [60, 66, 68, 70, 72, 73, 74, 76, 77, 78, 81, 82, 83, 84]  # (Windows NT 10.0) AppleWebKit/537.36
    # ~ ff_versions = [60, 66, 68, 70, 72, 73, 74, 76, 77, 78, 81, 82, 83, 84]  # (Windows NT 6.1)
    # ~ ff_versions = [82, 83, 84]                                              # (X11; Ubuntu; Linux x86_64;
    # ~ ff_versions = [60, 66, 68, 70, 72, 73, 74, 76, 77, 78, 81, 82, 83, 84]  # (iPad; CPU OS 12_2 like Mac OS X) (solo mp4, sin rtmp)
