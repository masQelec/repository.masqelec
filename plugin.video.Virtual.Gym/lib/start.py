...
def main():
	...
	add_dir('[COLOR white]Buscar[/COLOR]', 'searchlink', 98, icon, fanart)
	add_dir('[COLOR yellow]Calentamiento [/COLOR][COLOR white](Con Patry Jordan)[/COLOR]', u_tube, 2, icon, fanart)
...
if mode == None or url == None or len(url) < 1:
	...
	try:
		...
		xbmc.executebuiltin("XBMC.Notification(Virtual Gym, [COLOR green]Cargando contenido ...[/COLOR] ,5000)")
